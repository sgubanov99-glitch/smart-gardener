// src/ui/tsypa.js — Цыпа, проактивный маскот-агроном (ревизия 2.117, выверенная копия)
// 2.117: мобильный режим (matchMedia max-width:900px): аватар 44px (CSS), пузырь скрыт
//        (.tsypa-quiet) и показывается только по тапу на 6 секунд; позиции — 4 угла;
...
function posPool() {
  return isMobile() ? [0, 2, 3, 5] : [0, 1, 2, 3, 4, 5];
}
